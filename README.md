...
![Build](https://sodality/workflows/Go/badge.svg)
...
* **[Github Actions Workflows](https://sodality/tree/main/.github/workflows)** - Pre-configured Github Actions to run automated builds and publish image to Github Packages
* **[Dockerfile](https://sodality/blob/main/Dockerfile)** - Dockerfile to generate docker builds.
* **[docker-compose](https://sodality/blob/main/docker-compose.yml)** - Docker compose script to start service in production mode.
